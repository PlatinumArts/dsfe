...
and/or modify it under the terms of the CC0 License.
...
following Textures created by BlockMen (CC0):
  door_trapdoor.png
...
Obsidian door textures by red-001 based on textures by Pilzadam and BlockMen: CC0
  door_obsidian_glass.png

Glass door textures by red-001 based on textures by celeron55: CC BY-SA 3.0
  door_glass.png
All other textures (created by PilzAdam): CC0
