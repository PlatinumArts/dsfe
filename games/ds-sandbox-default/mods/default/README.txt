...
VanessaE's animated torches (DWYWPL):
  default_torch_animated.png
  default_torch_on_ceiling_animated.png
  default_torch_on_floor_animated.png
  default_torch_on_floor.png

RealBadAngel's animated water (DWYWPL):
...
paramat (CC BY-SA 3.0):
  ...
  default_stone_brick.png, derived from a texture by Cisoun (DWYWPL)
  default_desert_stone_brick.png, derived from a texture by VanessaE (DWYWPL)
