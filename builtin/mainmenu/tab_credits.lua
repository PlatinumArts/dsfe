...
tab_credits = {
	...
	cbf_formspec = function (tabview, name, tabdata)
			...
			return "label[0.5,3.2;Minetest " .. core.get_version() .. "]" ..
				--"label[0.5,3.5;http://SandboxGameMaker.com]" ..
				"image[0.5,1;" .. core.formspec_escape(logofile) .. "]" ..
				"tablecolumns[color;text]" ..
				"tableoptions[background=#00000000;highlight=#00000000;border=false]" ..
				"table[3.5,-0.25;8.5,5.8;list_credits;" ..
				"#FFFF00," .. fgettext("D.'s Sandbox Developers") .."," ..
				",Michael Tomaino <platinumarts@gmail.com>,"..
				",http://SandboxGameMaker.com,"..
				"#FFFF00," .. fgettext("D.'s Sandbox uses Minetest as a base") .."," ..
				",,"..
				"#FFFF00," .. fgettext("Minetest Credits")  .."," ..
				"#FFFF00," .. fgettext("No credits below are affiliated with D.'s Sandbox Developers")  .."," ..
